...
function updateJSON() {
  ...
  _data["books"] = unflatten(JSON.parse(electronFs.readFileSync(path + 'books.json', 'utf8')));
  _data["codes"] = unflatten(JSON.parse(electronFs.readFileSync(path + 'codes.json', 'utf8')));
  _data["students"] = unflatten(JSON.parse(electronFs.readFileSync(path + 'students.json', 'utf-8')));
}
